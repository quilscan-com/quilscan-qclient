...
impl<'t, 'g> Prover<'t, 'g> {
    ...
    pub fn commit(&mut self, v: Scalar, v_blinding: Scalar) -> (CompressedPoint, Variable) {
        let i = self.v.len();
        self.v.push(v);
    ...
    pub fn prove(mut self, bp_gens: &BulletproofGens) -> Result<R1CSProof, R1CSError> {
        ...
        let A_I1 = Point::multiscalar_mul(
        ...
        let A_O1 = Point::multiscalar_mul(
