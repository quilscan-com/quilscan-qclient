...
template <typename T>
double test_ot(T * ot, NetIO *io, int64_t party, int64_t length) {
...
template <typename T>
double test_cot(T * ot, NetIO *io, int64_t party, int64_t length) {
...
template <typename T>
double test_rot(T* ot, NetIO *io, int64_t party, int64_t length) {
	block *b0 = new block[length], *r = new block[length];
...
template <typename T>
double test_rcot(T* ot, NetIO *io, int64_t party, int64_t length, bool inplace) {
	block *b = nullptr;
	PRG prg;
