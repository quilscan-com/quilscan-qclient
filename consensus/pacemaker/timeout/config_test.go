...
// TestConstructor tests that constructor performs needed checks and returns
// expected values depending on different inputs.
func TestConstructor(t *testing.T) {
	...
	require.Equal(t, float64(2000), c.MaxTimeoutStateRebroadcastInterval)
	...
	require.True(t, models.IsConfigurationError(err))
